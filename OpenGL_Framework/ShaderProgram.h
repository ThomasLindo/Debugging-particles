...
/*
  ///////////////////
 // ShaderProgram // 2019 Stephen Thompson
///////////////////
...
public:
	...
	GLint getUniformLocationSafe(const std::string &uniformName) const;
	GLint getUniformLocation(const std::string &uniformName) const;

	void sendUniform(const std::string &name, float scalar) const;
...
private:
	bool _IsInit = false;
	Shader *_VertShader; // GL_VERTEX_SHADER
	Shader *_TeseShader; // GL_TESS_EVALUATION_SHADER
	Shader *_TescShader; // GL_TESS_CONTROL_SHADER
	Shader *_GeomShader; // GL_GEOMETRY_SHADER
	Shader *_FragShader; // GL_FRAGMENT_SHADER
	Shader *_CompShader; // GL_COMPUTE_SHADER
	GLuint _Program = 0;
	...
	static ShaderProgram _ProgramDefault;
